...
public class PortalControlador {
    ...
    @PreAuthorize("hasAnyRole('ROLE_CLIENTE', 'ROLE_ADMIN', 'ROLE_PROFESIONAL')")
    @GetMapping("/inicio")
            ...
            switch(tipoDeAtencion)
            {
               case "1" :
                  // Atencion
                   ...
                   listaProfesionales = profesionalServicio.listarProfesionalPorRol(EnumRolProfesional.VETERINARIO);
               ...
               case "2" :
                   //Peluqueria
                  listaProfesionales = profesionalServicio.listarProfesionalPorRol(EnumRolProfesional.PELUQUERO);
                   modelo.addAttribute("actProfe", 2);
               ...
               case "3" :
                  // Vacunacion
                   listaProfesionales = profesionalServicio.listarProfesionalPorRol(EnumRolProfesional.ENFERMERO);
